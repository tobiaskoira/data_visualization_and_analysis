...
function Filters({ filterOptions, onFilterChange }) {
  ...
  const [anneeNotificationRange, setAnneeNotificationRange] = useState([1900, 2030]);
  ...
  return (
    <Box>
      ...
      <Typography gutterBottom>Année de Notification</Typography>
      <Slider
        value={anneeNotificationRange}
        onChange={(e, newValue) => setAnneeNotificationRange(newValue)}
        valueLabelDisplay="auto"
        min={1900}
        max={2030} 
      />
